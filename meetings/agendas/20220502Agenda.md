...
1. Data Collection
  The Activity description or select box? <br>
    Task list with an ‘other’ button. If ‘other’ is selected, show a text field to capture the activity <br>
    Multiple Pictures: <br>
      The chit <br>
      The [Aadhaar](https://uidai.gov.in/)/PAN card <br>
      Picture of the activity <br>
    Short video <br>
    Short audio <br>
...
7. Language is a big ask for the app right now.
8. Gamification?
